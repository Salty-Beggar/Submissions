// https://atcoder.jp/contests/abc235/submissions/68884941
// OBSERVATION: The problem of the code is that it does not support self links and double links within the main graph itself.
...
long long int findHeaviestConnection(long long int u, long long int v) {
    ...
    if (depthDiff != 0) for (long long int j = 0; j < MAX_LOGN; j++) {
